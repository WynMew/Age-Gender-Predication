...
from dataloaderimdbwiki256 import *
from AgePreModel256 import *
...
def add(x):
    with open('TrainAgePre256Log',"a+") as outfile:
        outfile.write(x + "\n")
...
for epoch in range(start_epoch, end_epoch + 1):
    ...
    checkpoint_name = os.path.join('imdbwikiAgePre256_CrossEntloss.pth.tar')
    save_checkpoint({
        'epoch': epoch + 1,
