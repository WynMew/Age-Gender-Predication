...
from AgePreModelResNet256 import *
...
#checkpoint = torch.load('imdbwikiAgePreResNet256_CrossEntloss.pth.tar', map_location=lambda storage, loc: storage)
#checkpoint = torch.load('best_imdbwikiAgePreResNet256_CrossEntloss.pth.tar', map_location=lambda storage, loc: storage)
#checkpoint = torch.load('best_imdbwikiAgePreReResNet256_CrossEntloss.pth.tar', map_location=lambda storage, loc: storage)
checkpoint = torch.load('best_imdbwikiAgePreResNet18Det256_CrossEntloss.pth.tar', map_location=lambda storage, loc: storage)
