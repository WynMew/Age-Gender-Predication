...
def main():
    ...
    dataset = 'imdbAge'
    Path = '/home/HDD4/Database/wikiAge'
    Image_list = '/home/HDD4/Database/imdbAge/wikiagelist'
    Save_root = '/home/HDD4/Database/wikiAge/wikiMTCNN'
    Save_list = '/home/HDD4/Database/wikiAge/wikiMTCNN.txt'
    ...
    for m in it:
        ...
        if max(height, width) > restrict_size:
            ...
            img = cv2.resize(img, (np.int32(width * scale), np.int32(height * scale)), 0.0, 0.0,
        ...
        if boundingboxes.size == 5:
            print(boundingboxes)
            img = img[max(boundingboxes[0][1], 0):min(boundingboxes[0][3], height),
                  max(boundingboxes[0][0], 0):min(boundingboxes[0][2], width)]
